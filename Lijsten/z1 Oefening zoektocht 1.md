...
Gegeven is de volgende lijst getallen:
...
">Vind de juiste oplossing (in deze lijst) door een programma te schrijven dat de stappen doorloopt. Je mag niet zelf gaan tellen of zoeken in de lijst. Begin met de lijst te kopiëren naar jouw code.
</div>

- Sla het vierde element uit de lijst op in een variabele. *Denk eraan dat python vanaf 0 begin te tellen!*
- Sla het honderste element uit de lijst op in een variabele.
- Tel de elementen op.
- Doe deze som maal twee, en zoek het element in de lijst met als index dit resultaat.
- Print dit element
