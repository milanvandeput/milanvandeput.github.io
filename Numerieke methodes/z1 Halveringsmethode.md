...
<img src="/assets/images/halvering2.png" style="width: 20%; max-width: 100%; height: auto;">

Aangezien *M* boven de x-as ligt, wordt *M* de nieuwe *B*.

<img src="/assets/images/halvering3.png" style="width: 20%; max-width: 100%; height: auto;">
...
<img src="/assets/images/halvering4.png" style="width: 20%; max-width: 100%; height: auto;">
...
<div style="
    ...
    border: 1px solid #ddd;
">
Pas je code van de halveringsmethode aan zodat de berekeningen stoppen wanneer er een bepaalde nauwkeurigheid $N$ wordt bereikt.

Test waarden voor $N$ uit zoals 0.001, 0.0000001, 0.00000000001, ...
</div>
