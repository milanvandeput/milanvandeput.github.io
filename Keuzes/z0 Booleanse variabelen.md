...
```
Ook ongelijkheden **(< en >)** kunnen gebruikt worden om booleaanse variabelen aan te maken. Je kan ook *!=* gebruiken om 'is niet gelijk aan' te testen.
